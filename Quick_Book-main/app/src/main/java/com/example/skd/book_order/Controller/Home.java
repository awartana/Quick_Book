...
import com.example.skd.book_order.Model.Category;
import com.example.skd.book_order.Model.Order;
import com.example.skd.book_order.ViewHolder.MenuViewHolder;
...
category =database.getReference("Category");
        ...
        txtFullNsme =(TextView)headerView.findViewById(R.id.txtFullName);
        txtFullNsme.setText(Common.currentUser.getName());
